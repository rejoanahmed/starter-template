...
function AccountPage() {
  ...
  return (
    <div className="space-y-6 px-6 py-8">
      ...
      {/* Stripe Connect Status - Only show if user has or had a Stripe account */}
      {hasStripeAccount && (
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        This will disconnect it from your account and you'll
                        need to set it up again. This action cannot be undone.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
